...
export default function Experience({ data }) {
  return (
    <section id="experience" style={{ padding: "100px 40px", background: "transparent", borderTop: "1px solid rgba(255,255,255,0.05)" }}>
      <div style={{ maxWidth: 760, margin: "0 auto" }}>
        <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: "clamp(26px,3vw,40px)", fontWeight: 700, color: dark, marginBottom: 52 }}>
        ...
        <div style={{ position: "relative", paddingLeft: 30 }}>
          ...
          {data.experience.items.map((exp, i) => (
            ...
            >
              {/* Dot */}
              <div style={{ position: "absolute", left: -37, top: 22, width: 14, height: 14, borderRadius: "50%", background: i === 0 ? "rgba(255,255,255,0.8)" : "rgba(255,255,255,0.1)", border: `2px solid rgba(255,255,255,0.3)` }} />
